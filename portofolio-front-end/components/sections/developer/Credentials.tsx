...
export default function Credentials() {
  const certs = [
    { id: 'azure-ai-900', title: 'Azure AI 900 Fundamentals', issuer: 'Microsoft', image: '/image_73338d.png' },
    { id: 'cloud-architect', title: 'Cloud Architect Basics', issuer: 'Various', image: '/image_73338d.png' },
    { id: 'softdev-mastery', title: 'SoftDev Mastery', issuer: 'Tech Institute', image: '/image_73338d.png' },
    { id: 'flutter-expert', title: 'Flutter Developer Expert', issuer: 'Dicoding', image: '/image_73338d.png' },
    { id: 'backend-path', title: 'Backend Developer Path', issuer: 'Dicoding', image: '/image_73338d.png' },
    { id: 'python-data', title: 'Python Data Science', issuer: 'Coursera', image: '/image_73338d.png' },
    { id: 'frontend-expert', title: 'Frontend Web Expert', issuer: 'Dicoding', image: '/image_73338d.png' },
    { id: 'uiux-fundamentals', title: 'UI/UX Design Fundamentals', issuer: 'Google', image: '/image_73338d.png' },
    { id: 'agile-scrum', title: 'Agile Scrum Master', issuer: 'Scrum.org', image: '/image_73338d.png' },
  ];
    ...
    <section id="credentials" className="text-center space-y-12 pt-20 transition-colors duration-300">
      <div className="space-y-4 border-b border-[#7DD3FC]/20 dark:border-[#991B1B]/30 pb-8 text-center">
        ...
        <p className="text-lg md:text-xl text-[#0F172A]/70 dark:text-white/70">
          Certifications and official recognition of my skills.
        </p>
      </div>
