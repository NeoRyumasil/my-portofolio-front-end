...
import { Plus, Edit2, Trash2, X, Save, Image as ImageIcon, Calendar, Briefcase, Code, AlignLeft, Type, Link as LinkIcon, ExternalLink, Gamepad2 } from 'lucide-react';
...
export default function GameProject() {
  // Data default untuk Game Projects
            ...
            <div className="p-6 md:p-8 flex-1 flex flex-col">
              ...
              <div className="mt-auto pt-4 border-t border-[#7DD3FC]/10 dark:border-[#991B1B]/20">
                {project.url ? (
                  ...
                  >
                    Play / View Game <ExternalLink size={14} />
                  </a>
                ) : (
