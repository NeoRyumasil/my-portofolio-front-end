...
export default function TopProjects() {
  const topProjects = [
    { id: 'gudang-damar', title: 'Gudang Damar', role: 'Fullstack Developer' },
    { id: 'ai-chat', title: 'AI Chat Assistant', role: 'AI Developer' },
    { id: 'cv-sign-language', title: 'CV Sign Language', role: 'PKM-KC Lead' },
  ];
      ...
      <div className="space-y-4 flex-1">
        {topProjects.map((project, index) => (
          <div key={index} className="group flex items-center justify-between p-4 bg-[#F0F9FF]/50 dark:bg-[#000000]/50 rounded-2xl border border-[#7DD3FC]/10 dark:border-[#991B1B]/10 hover:border-[#0369A1]/50 dark:hover:border-[#E11D48]/50 hover:shadow-md hover:-translate-y-1 transition-all duration-300 cursor-pointer">
            <div>
              <h3 className="font-bold text-[#0F172A] dark:text-white font-space group-hover:text-[#0369A1] dark:group-hover:text-[#E11D48] transition-colors">{project.title}</h3>
